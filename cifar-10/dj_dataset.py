    ...
    def search(self):
        ...
        while frontier_seed_count_100c < max_seed_count:
            ...
            if accepted:
                ...
                # if second_cls_confidence > 0.01 and frontier_seed_count_not_100c < max_seed_count:
                ...
                if second_cls_confidence < 0.01 and frontier_seed_count_100c < max_seed_count:
...
if __name__ == "__main__":
    for i in range(10):
        run_mimicry(i)
    # # run_mimicry(0, 116191)
    # # run_mimicry(1, 117658)
    # run_mimicry(6, 13249)
    # run_mimicry(7, 3800)
