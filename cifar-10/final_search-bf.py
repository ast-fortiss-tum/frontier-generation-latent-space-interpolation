...
class mimicry:
    ...
    def search(self):
        targeted = False
        # seeds_root = "cifar-10/final-cifar-10/100"
        # p_100 = True
        seeds_root = "cifar-10/final-cifar-10/not_100"
        p_100 = False
                ...
                if seed.endswith(".json"):
                  ...
                  while not found_mutation and not tried_all_layers and self.stylemix_seed <= self.stylemix_seed_limit:
                      ...
                      for idx, layer in enumerate(self.layers):
                          ...
                          print(f"Accepted: {m_accepted} - Confidence: {confidence} - Predictions: {[f'{p:.4f}' for p in m_predictions]}")
